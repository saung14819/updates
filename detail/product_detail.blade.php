...
@section('content')
    ...
    <div class="container">
            ...
            <div class="row" style="margin-top:10px;margin-left:2px;">
                <table class="table success" id='depnote_table'>
                    ...
                    <td>
                        ...
                        <a href="{{ url('/del_dept_note/'.$jn->id.'/'.$products->id) }}" class='btn btn-danger' role="button" > Delete</a>
        ...
        <div class="row">
            <div class="col-md-4">
                <h4>Product Name:<b>{{$products->description}}</b></h4>
                        ...
                        <div class="row">
                            <table class="table success">
                                ...
                                <tr >
                                    ...
                                    <td><b>{{$products->job}}</b></td>
                                </tr>
                                <tr>
                                    <th class="info">Product Description:</th>
                                    <td><input type="text" class="form-control" value="{{$products->description}}" disabled/> </td>
                                </tr>
                                <tr>
                                    <th class="info">Product Additional Description:</th>
                                    <td><input type="text" class="form-control" value="{{$products->additionalDescription}}" disabled/> </td>
                                </tr>
                                <tr>
                                    <th class="info">Product PO:</th>
                                    <td><input type="text" class="form-control" value="{{$products->U_PO}}" disabled/> </td>
                                </tr>
                                <tr>
                                    <th class="info">Product Qty:</th>
                                    <td><input type="text" class="form-control" value="{{$products->qtyOrdered}}" disabled/> </td>
                                </tr>
                                <tr>
                                    <th class="info">Promise Date:</th>

                                    <td>
                                        @if($products->U_DueDate!=null)
                                            <input type="text" id="date" class="form-control" value="{{$products->U_DueDate->toDateString()}}" disabled/>
                                        @else
                            ...
                            <div class="pull-right">
                                <a data-target="#update_product_modal" data-toggle="modal" href="#add_product_modal"  role="button" aria-haspopup="true" ><i class="far fa-edit"></i> Edit product</a>&nbsp;/&nbsp;
                                <a data-target="#duplicate_product_modal" data-toggle="modal" href="{{ url('/dup_sin_product/'.$products->id ) }}"  role="button" aria-haspopup="true" ><i class="far fa-clone"></i> Duplicate product</a>
                            </div>
            ...
            <div class="col-md-8">
                ...
                <h3><u>Total Parts: {{count($jobparts)}} </u> </h3>
                <a href="#" id="expand_all" class="pull-right">
                    <i class="far fa-folder-open"></i> Show all parts
                </a>
                <br/>
                <div class="panel-group" id="parts">
                    @php $part_count=1 @endphp
                    @foreach($jobparts as $job_part)
                     @if($job_part->description!=='Shipping' || $job_part->description!=='shipping')
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                ...
                                <a data-target="#duplicate_part_modal" data-toggle="modal" href="#duplicate_part_modal"  role="button" class="btn btn-sm btn-info" onclick="dup_parts('{{$job_part->job}}','{{$job_part->jobPart}}')"><span style="color:white;">Duplicate Part</span></a>
                            </h4>
                        </div>
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table success">
                                    ...
                                    <tr >
                                        ...
                                        <td>&nbsp;-&nbsp;</td>
                                        <td>
                                            <select class="form-control" name="sales" id="sales{{$job_part->jobPart}}" readonly>
                                                @foreach($sales as $sp)
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea rows="2" cols="70" type="text" name="desc2" class="form-control" maxlength="50" id="desc2{{$job_part->jobPart}}" readonly>{{$job_part->additionalDescription}}</textarea></td>
                                    </tr>
                                    <tr>
                                        <th> Quantity:</th>
                                        <td>
                                                    ...
                                                    @else
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>&nbsp;</td>
                                                                <td> <a data-target="#myList" data-id="{{$job_part->jobPart}}" data-toggle="modal" href="#myList"  role="button" aria-haspopup="true" id="add_list{{$job_part->jobPart}}" class="open-AddListDialog"><span id="change_list{{$job_part->jobPart}}">+ Add Price list</span></a></td>
                                                            </tr>
                                                        </table>
                              ...
                              <button type="button" class="btn btn-group btn-md btn-success center-block"  onclick="calculate({{$job_part->jobPart}})" id="btn-edit{{$job_part->jobPart}}"><i class="far fa-edit"></i> Edit Part Details</button>
                                ...
                                <table class="table success">
                                    ...
                                    <tr >
                                       <td>
                                        ...
                                        <td>
                                            <a data-target="#PrepModal" data-toggle="modal" href="#PrepModal"  role="button" aria-haspopup="true" class="pull-right" onclick="add_prepress('{{$products->job}}','{{$job_part->jobPart}}','{{$job_part->jobProduct}}')">
                                                + Add Prepress
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                <ul>
                                    @foreach($prepress_list as $prep)
                                        @if($prep->id==$job_part->prepressWorkflow)
                                            <li><h5><b>{{$prep->description}}</b>&nbsp;- <span class="text-right"><a data-target="#PrepModal" data-toggle="modal" href="#PrepModal"  role="button" aria-haspopup="true" onclick="add_prepress('{{$products->job}}','{{$job_part->jobPart}}','{{$job_part->jobProduct}}')"><i class="fas fa-edit"></i> Change Prepress Mode</a></span></h5> </li>
                                        @endif
                                    @endforeach
                                </ul>
                                <table class="table success">
                                    <tr >
                                        ...
                                        <td>
                                            <a data-target="#PrintModal" data-toggle="modal" href="#PrintModal"  role="button" aria-haspopup="true" class="pull-right" onclick="add_printer('{{$products->job}}','{{$job_part->jobPart}}','{{$job_part->jobProduct}}')">
                                                + Add Printer
                                            </a>
                                        </td>
                                    </tr>
                                            ...
                                            <li>
                                                @foreach($printers as $prt)
                                                    @if($prt->id==$print->press)
                                                        ...
                                                        <h5><b>{{$prt->description}}</b> | Note: {{$prt->note}}&nbsp;- <span class="text-right"><a href="{{ url('/delete_printer/'.$print->id.'/'.$products->job.'/'.$job_part->jobProduct) }}"><i class="far fa-trash-alt"></i> Remove Printer</a></span></h5>
                                ...
                                <table class="table success">
                                    <tr >
                                        ...
                                        <td>
                                            <a data-target="#PrintModeModal" data-toggle="modal" href="#PrintModeModal"  role="button" aria-haspopup="true" class="pull-right" onclick="add_print_mode('{{$products->job}}','{{$job_part->jobPart}}','{{$job_part->jobProduct}}')">
                                                + Add Print Mode
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                <table class="table success">
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <a href="#" id="expand_all" class="pull-right">
                                                <a data-target="#PrintMaterialModal" data-toggle="modal" href="#PrintMaterialModal"  role="button" aria-haspopup="true" class="pull-right" onclick="add_print_material('{{$products->job}}','{{$job_part->jobPart}}','{{$job_part->jobProduct}}')"> + Add Printing Material </a>
                                            </a>
                                        </td>
                                    </tr>
                                        ...
                                        @if($job_part->jobPart==$mat->jobPart)
                                            ...
                                            <p>
                                                ...
                                                <b>
                                                 ...
                                                 Inventory Item - {{$mat->description}}  -  <span class="text-right"><a href="{{ url('/delete_job_material/'.$mat->id.'/'.$products->job.'/'.$job_part->jobProduct.'/'.$job_part->jobPart) }}"><i class="far fa-trash-alt"></i> Remove Material</a></span>
                                                    ...
                                                    @else
                                                        <b>
                                                           ...
                                                           Standard Paper - {{$mat->description}} / Weight : {{$mat->weight}} / Size: {{$mat->buySize}}- <span class="text-right"><a href="{{ url('/delete_job_material/'.$mat->id.'/'.$products->job.'/'.$job_part->jobProduct.'/'.$job_part->jobPart) }}"><i class="far fa-trash-alt"></i> Remove Material</a></span>
                                ...
                                <table class="table success">
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <a data-target="#FinishingOpModal" data-toggle="modal" href="#FinishingOpModal"  role="button" aria-haspopup="true" class="pull-right" onclick="add_finish_op('{{$products->job}}','{{$job_part->jobPart}}','{{$job_part->jobProduct}}')">
                                            + Add Finishing
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                @if($finishing!==null)
                                                    ...
                                                    @foreach($finishing_operation as $fop)
                                                        @if($fop->id==$fin->finishingOperation)
                                                            ...
                                                            <td style="width:300px;">
                                                                ...
                                                                {{$fin->U_Material}}
                                                                @else
                                                                    <a data-target="#FinishingMaterialModal" data-toggle="modal" href="#FinishingMaterialModal"  role="button" aria-haspopup="true" onclick="add_finishing_material('{{$products->job}}','{{$job_part->jobPart}}','{{$fin->id}}','{{$job_part->jobProduct}}')"> + Add Finishing Material </a>
                                                                @endif
                                                            </td>
                                                            <td>@if ($fin->note!==null){{$fin->note}} @else - @endif</td>
                                                            <td><a href="{{ url('/del_fin/'.$job_part->jobPart.'/'.$fin->id.'/'.$products->job.'/'.$job_part->jobProduct) }}"><i class="far fa-trash-alt"></i> Remove </a></td>
                                                        @endif
                                                    @endforeach
                                                </tr>
                                    ...
                                    <tr>
                                        <td>
                                            @if($count!==0)
                                            <button class="btn btn-group btn-sm btn-info center-block" type="button" id="arrange_btn" onclick="arrange_sort('{{$fin->id}}','{{$products->job}}','{{$job_part->jobPart}}','{{$job_part->jobProduct}}')">Re-arrange</button>
                                            @endif
                                        </td>
                                    </tr>
                                @endif
    ...
    <div class="modal fade" id="update_product_modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width:1000px;">
            <div class="modal-content" style="overflow-x: scroll;">
                ...
                <div class="modal-body ">
                    ...
                    <!-- content goes here -->
                    <form role="form" method="get" action="{{ action('PaceController@update_single_product') }}">
                        @csrf
                        <div>
                            <table class="table success">
                                <tr>
                                    ...
                                    @if ($products->description !=='Shipping')
                                        <tr >
                                            <input type="hidden" class="form-control" value="{{$products->id}}" name="product_id"/>
                                            <input type="hidden" class="form-control" value="{{$products->job}}" name="job_number"/>
                                            <td>
                                                <textarea class="form-group" rows="2" cols="30" name="description"> {{$products->description}}</textarea>
                                            </td>
                                            <td><textarea class="form-group" rows="2" cols="30" name="description2">{{$products->additionalDescription}}</textarea></td>
                                            <td><textarea class="form-group" rows="2" cols="30" name="po">{{$products->U_PO}}</textarea></td>
                                            <td><input type="text" class="form-control" value="" name="promise_date"/></td>
                                        </tr>
    ...
    <div class="modal fade" id="duplicate_product_modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width:1980px;">


                    <!-- content goes here -->
                    @include('detail.sub_product_detail');
    ...
    <!--duplicate product modal ends-->


    <!--duplicate part modal -->
    <div class="modal" id="duplicate_part_modal" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
        <form  id="dup_part_form">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="add_contact_formTitle">How do you want to duplicate?</h3>
                    ...
                    <div class="modal-body">
                        <div class="form-group" >
                            <div class="row" >
                                <div class="col-xs-6 job-label"style="text-align:right;">
                        ...
                        <div class="form-group" >
                            <div class="row" >
                                ...
                                <div class="col-xs-4">
                                    <select name="product" class="form-control" id="dup_part_product">


                                        @foreach ($all_products as $all_pro)

                                            @if($all_pro->description!="Shipping")
                                                echo "<option value='{{$all_pro->id}}'>{{$all_pro->description}}</option>";
                                            @endif
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <input type="hidden" name="job" id="job" value=""><br>
                    <input type="hidden" name="part" id="part" value=""><br>

                    <input type="hidden" id="dup_part_jobproduct_row" >
                    <div class="modal-footer">
                        <input type="button" data-dismiss="modal" onclick='submit_dup_part_form()' id="submit" value="Duplicate" class="btn btn-success">
    ...
    <div class="modal fade" id="PrepModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <form action= "{{ action('PaceController@change_prepress') }}" method="post">
            @csrf
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="PrintModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <form action= "{{ action('PaceController@set_printer') }}" method="post">
            @csrf
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <div class="modal fade" id="PrintModeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <form action= "{{ action('PaceController@add_print_mode') }}" method="post">
            @csrf
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <div class="modal fade" id="PrintMaterialModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <form action= "{{ action('PaceController@set_job_material') }}" method="post">
            @csrf
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <div class="modal fade" id="FinishingMaterialModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <form action= "{{ action('PaceController@set_fin_mat') }}" method="post">
            @csrf
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <div class="modal fade" id="FinishingOpModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <form action= "{{ action('PaceController@set_finish_op') }}" method="post">
            @csrf
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" data-dismiss="modal" class="btn btn-danger">Cancel</button>
                        <input type='hidden' name='job' value={{$products->job}} id="ujob"/>
    ...
    <script>
        ...
        function dup_parts(job,part_id) {
            $('#job').val(job);
            $('#part').val(part_id);
        }
        ...
        function submit_dup_part_form(){
            var product=$("#dup_part_product").val();
            var part=$("#part").val();
            var job=$("#job").val();
            var times=$("#times").val();

            console.log(product,part,job,times)
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
                ...
                $.ajax({
                    type:'POST',
                    url: '/single_part_duplicate',
                    data: {product:product,part:part,job:job,times:times},
                    async: false,
                    success: function(response) {
                        ...
                        alert("Total"+time+"Parts have been added to the selected product");
                        /*$.ajax({
                            type:'POST',
